...
demographic and subnational heterogeneity. Uses pretax income GINI coefficient
- temperature interaction to test robustness to heterogeneity in 
inequality to temperature-mortality response

Inputs
------

- `0_data_cleaning/3_final/global_mortality_panel` - Final mortality panel.
- `0_data_cleaning/2_cleaned/institutional_covariates/wid_gini.dta` - final institutional quality data

Outputs
-------

- `data/1_estimation/1_ster/age_spec_interacted`
    - `Agespec_interaction_response_inequality_sample.ster` - Ster file containing
    ...
    - `ster'/Agespec_interaction_response_gini.ster` - Ster file containing results from
...
Summary of main models:
    ...
    2. 4th-order polynomial OLS, with (tavg x gini) interactions and
...
do "$REPO/mortality/1_estimation/1_utils/inequality_merge.do"
...
estimates save "`ster'/Agespec_interaction_response_inequality_sample.ster", replace


* 2) main specification but with additional gini covariate x tavg interaction terms
...
reghdfe deathrate_w99 c.tavg_poly_1_GMFD#i.agegroup c.tavg_poly_2_GMFD#i.agegroup ///
    ...
    c.tavg_poly_1_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup c.tavg_poly_2_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup ///
    c.tavg_poly_3_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup c.tavg_poly_4_GMFD#c.lr_tavg_GMFD_adm1_avg#i.agegroup ///
    c.tavg_poly_1_GMFD#c.avg_adm0_gini#i.agegroup c.tavg_poly_2_GMFD#c.avg_adm0_gini#i.agegroup ///
    c.tavg_poly_3_GMFD#c.avg_adm0_gini#i.agegroup c.tavg_poly_4_GMFD#c.avg_adm0_gini#i.agegroup ///
        , absorb( adm0_agegrp_code##c.prcp_poly_1_GMFD  adm0_agegrp_code##c.prcp_poly_2_GMFD ///
                  i.adm2_code#i.CHN_ts#i.agegroup  i.adm0_code#i.year#i.agegroup ) ///
        cluster(adm1_code)
estimates save "`ster'/Agespec_interaction_response_gini.ster", replace
