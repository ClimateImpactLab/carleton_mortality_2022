...
for the Indian data : a polynomial, or a binned regression -- we're trying here
multiple options for the binned regression. 
...
to the main estimating equation in Carleton et al. (2021). 
