...
3. Download data either from [Zenodo](https://zenodo.org/record/6416119#.Yn6JHRPMIlI) of from the [QJE Dataverse](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/FXXLYZ) and unzip it somewhere on your machine with at least 85 GB of space. Let's call this location `yourDATA`.
